...
![Picklink browser picker](docs/screenshots/picker-en.png)
...
![Browser and profile shortcuts](docs/screenshots/browsers-en.png)

## Download

Download **Picklink 1.0.0** from [GitHub Releases](https://github.com/marilynje/picklink/releases/latest).
